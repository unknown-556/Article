...
const ArticleCard = ({ title, description, image, categories, onClick }) => {
  return (
    <div
      className="flex lg:w-full lg:h-60 flex-col md:flex-row bg-black text-white shadow-lg rounded-lg overflow-hidden transition-transform hover:scale-[1.02] hover:shadow-xl cursor-pointer mb-8"
      onClick={onClick}
    >
